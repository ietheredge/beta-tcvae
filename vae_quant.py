...
from plot_latent_vs_true import plot_vs_gt_guppies, plot_vs_gt_shapes, plot_vs_gt_faces  # noqa: F401
...
def plot_elbo(train_elbo, save, epoch):
    ...
    ax.set_prop_cycle([cm(1.*i/len(train_elbo)) for i in range(len(train_elbo))])
